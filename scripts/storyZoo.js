...
function fStoryBuildZoo(objStory) {
    ...
    strQuestionA = prompt(`Does ${objStory.firstName} have a favorite sport - if so what is it?`, `no`)
    ...
    strQuestionB = prompt(`Did ${objStory.firstName} have an ice cream (yes/no)?`, `yes`)
